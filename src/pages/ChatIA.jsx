...
export const ChatIA = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-dark mb-2">CHAT COM IA</h1>
        <p className="text-white font-medium">Assistente especializada em psicologia para apoiar sua prática clínica</p>
      </div>
